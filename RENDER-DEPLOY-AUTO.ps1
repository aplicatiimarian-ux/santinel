...
if (-not $neonURL -or $neonURL.Trim() -eq "") {
    ...
    Write-Host "STEP 1: Using provided Neon connection string" -ForegroundColor Yellow
    Write-Host "============================================================" -ForegroundColor Yellow
    Write-Host ""
    Write-Host "[OK] Neon URL provided as parameter" -ForegroundColor Green
    Write-Host ""
}
...
if (-not $renderURL -or $renderURL.Trim() -eq "") {
    ...
    Write-Host "[OK] Render URL provided as parameter: $renderURL" -ForegroundColor Green
}
