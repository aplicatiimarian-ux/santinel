...
REM Delete the broken script
if exist RENDER-COMPLETE-DEPLOY.ps1 (
    echo Removing broken script...
    del RENDER-COMPLETE-DEPLOY.ps1
)

REM Recreate with correct content using PowerShell
echo Recreating corrected script...
...
'@ ; $content | Set-Content 'RENDER-COMPLETE-DEPLOY.ps1' -Encoding UTF8"

echo.
echo Script recreated successfully!
pause
