#!/usr/bin/env python3
"""
SANTINEL AUTOMATED DEPLOYMENT - All Phases (UTF-8 Fixed)
...
with open(services_dir / "stt_cascade_service.py", "w", encoding="utf-8") as f:
    f.write(STT_CASCADE_CONTENT)
log_success("Created stt_cascade_service.py")

with open(services_dir / "coach_output_service.py", "w", encoding="utf-8") as f:
    f.write(COACH_OUTPUT_CONTENT)
log_success("Created coach_output_service.py")

with open(services_dir / "evaluation_service.py", "w", encoding="utf-8") as f:
